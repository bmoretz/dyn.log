...
The **"dyn.log.config"** variable be either a predefined configuration (name) in the package, or a path to a local file that you have pre customized. This is useful for sharing a single log configuration across multiple packages or projects.
